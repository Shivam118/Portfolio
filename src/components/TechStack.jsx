...
const TechStack = () => {
  return (
    <div className="Techstack">
      ...
      <>
        <Tooltip anchorId="python" place="left" variant="warning" content="Python" />
        <Tooltip anchorId="cpp" place="top" variant="info" content="C++" />
        <Tooltip anchorId="js" place="top" variant="warning" content="Javascript" />
        ...
        <Tooltip anchorId="mongodb" place="left" variant="success" content="MongoDB" />
        <Tooltip anchorId="express" place="bottom" variant="warning" content="ExpressJs" />
        <Tooltip anchorId="graphql" place="bottom" variant="error" content="GraphQL" />
        <Tooltip anchorId="react" place="bottom" variant="info" content="ReactJs" />
        <Tooltip anchorId="node" place="right" variant="success" content="NodeJs" />
        <Tooltip anchorId="gcloud" place="left" variant="info" content="Google Cloud Platform" />
        {/* <Tooltip anchorId="django" place="bottom" variant="success" content="Django" /> */}
        <Tooltip anchorId="firebase" place="bottom" variant="warning" content="Firebase" />
        <Tooltip anchorId="next" place="right" variant="dark" content="Next.Js" />
        <Tooltip anchorId="jupyter" place="left" variant="warning" content="Jupyter" />
        <Tooltip anchorId="photoshop" place="bottom" variant="info" content="Photoshop" />
        <Tooltip anchorId="vscode" place="bottom" variant="info" content="VS Code" />
        <Tooltip anchorId="git" place="bottom" variant="error" content="Git" />
        <Tooltip anchorId="postman" place="right" variant="error" content="Postman" />
